    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'sale_status' => 'upcoming',
                'sale_created_by' => 1, // Reference to the user who created the sale, assuming the user with ID 1 exists
                'product_id' => 3, // Reference to the product with ID 2, assuming the product exists
                'created_at' => date('Y-m-d H:i:s'), // Current date and time
            ],
            [
                'sale_start_date' => '2023-07-10 00:00:00',
                ...
                'sale_status' => 'upcoming',
                'sale_created_by' => 1, // Reference to the user who created the sale, assuming the user with ID 1 exists
                'product_id' => 4, // Reference to the product with ID 2, assuming the product exists
                'created_at' => date('Y-m-d H:i:s'), // Current date and time
            ],
            [
                'sale_start_date' => '2023-07-10 00:00:00',
                ...
                'sale_status' => 'upcoming',
                'sale_created_by' => 1, // Reference to the user who created the sale, assuming the user with ID 1 exists
                'product_id' => 5, // Reference to the product with ID 2, assuming the product exists
                'created_at' => date('Y-m-d H:i:s'), // Current date and time
            ],
